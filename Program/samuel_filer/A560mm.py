...
path= "C:/Users/Samue/Desktop/BachelorGit/WebBachelor/Program/samuel_filer/samuel_bilder/A560mm.jpg"
...
hor_start = np.array([3231, 4416])
hor_end = np.array([9333, 4354])


#Defining vector direction for target reference
hor_x_mm_10 = (hor_end[0]-hor_start[0])/400*100
hor_y_mm_10 = (hor_start[1]-hor_end[1])/400*100
...
ver_start = np.array([6188,1322.5])
ver_end = np.array([6260, 7460])
intersection_point = []
...
pixel_size_horizontal = 400/abs(hor_end[0]-hor_start[0])
pixel_size_vertical = 400/abs(ver_end[1]-ver_start[1])
