...
path= "C:/Users/Samue/Desktop/BachelorGit/WebBachelor/Program/samuel_filer/samuel_bilder/A600mm.jpg"
...
hor_start = np.array([2458, 3875])
hor_end = np.array([9321, 3854])


#Defining vector direction for target reference
hor_x_mm_10 = (hor_end[0]-hor_start[0])/485*200
hor_y_mm_10 = (hor_start[1]-hor_end[1])/485*200
...
ver_start = np.array([5837.5,370])
ver_end = np.array([5844, 7291])
intersection_point = []
...
plt.quiver(intersection_point[0],intersection_point[1],hor_xy_mm_end[0],hor_xy_mm_end[1],color='g',units ='xy', scale=1,width=100)
