...
path= "C:/Users/Samue/Desktop/BachelorGit/WebBachelor/Program/samuel_filer/samuel_bilder/A2450mmVerH.jpg"
...
hor_start = np.array([3474,5202.5])
hor_end = np.array([4825,5202.5])
...
ver_start = np.array([4155,4520])
ver_end = np.array([4155,5877])
intersection_point = []

#Vertical vector center out
ver_x_mm_10 = (ver_end[0]-ver_start[0])/400*100
ver_y_mm_10 = (ver_start[1]-ver_end[1])/400*100
