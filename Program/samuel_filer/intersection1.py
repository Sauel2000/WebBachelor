...
hor_start = np.array([1922.5, 4143])
...
ver_start = np.array([5580,360])
ver_end = np.array([121.5+5580, 7432+360])
intersection_point = []
...
shot1_end = [intersection_point[0]+92,intersection_point[1]-861]

shot_center_start = [intersection_point[0],intersection_point[1]]       #origo
shot2_center_end = [intersection_point[0]+92,intersection_point[1]-861]
