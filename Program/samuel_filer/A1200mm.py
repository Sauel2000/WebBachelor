...
path= "C:/Users/Samue/Desktop/BachelorGit/WebBachelor/Program/samuel_filer/samuel_bilder/A1200mm.jpg"
...
hor_start = np.array([4327.5, 4171])
hor_end = np.array([7709, 4168.5])
...
ver_start = np.array([6010.5,2459])
ver_end = np.array([6010.5, 5859])
intersection_point = []
...
plt.quiver(intersection_point[0],intersection_point[1],hor_xy_mm_end[0],hor_xy_mm_end[1],color='g',units ='xy', scale=1,width=1)
