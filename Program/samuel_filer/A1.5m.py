...
path= "C:/Users/Samue/Desktop/BachelorGit/WebBachelor/Program/samuel_filer/samuel_bilder/A1.5m.jpg"
...
hor_start = np.array([4398, 4444])
hor_end = np.array([7101, 4444])


#Defining vector direction for target reference
hor_x_mm_10 = (hor_end[0]-hor_start[0])/485*242.5
hor_y_mm_10 = (hor_end[1]-hor_start[1])/485*242.5
...
ver_start = np.array([5754,3086])
ver_end = np.array([5757.5, 5796])
intersection_point = []
