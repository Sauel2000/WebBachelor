...
path= "C:/Users/Samue/Desktop/BachelorGit/WebBachelor/Program/samuel_filer/samuel_bilder/108mpRuter.jpg"
...
plt.quiver(1499.5,365.5,0,-2618,color='g',units ='xy', scale=1,width=10)
plt.quiver(42,1555,2872,0,color='red',units ='xy', scale=1,width=10)
