...
path= "C:/Users/Samue/Desktop/BachelorGit/WebBachelor/Program/samuel_filer/samuel_bilder/A120cm.jpg"
...
hor_start = np.array([3120.5,5703.5])
hor_end = np.array([5905, 5695.5])



# Define the starting and ending points of the second vector
ver_start = np.array([4520.5,4272])
ver_end = np.array([4518.5,7080.5])
intersection_point = []
...
pixel_size_horizontal = 390/abs(hor_end[0]-hor_start[0])
pixel_size_vertical = 390/abs(ver_end[1]-ver_start[1])
...
shot1_end = [intersection_point[0]-1348,intersection_point[1]+1349]
